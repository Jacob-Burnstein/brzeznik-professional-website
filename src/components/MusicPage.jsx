  ...
  return (
    <div className="musicContent">
      ...
      <p>
        ...
        seamlessly blends tradition with versatility when she plays. From
        symphony orchestras and intimate chamber groups to electrifying band
        tours and soulful solo recitals, she exudes confidence and artistry
        across diverse settings. With a rich repertoire spanning Bluegrass,
        Funk, Blues, Country, and Pop, Brianna transcends boundaries with her
        viola, infusing classical finesse with the raw energy of improvisation
        and alternative styles.
      </p>
      <p>
        Brianna also brings her expertise to the realm of teaching, offering
        tailored lessons on violin, viola, guitar, piano, and voice for students
        of all ages and abilities. With a compassionate approach, she
